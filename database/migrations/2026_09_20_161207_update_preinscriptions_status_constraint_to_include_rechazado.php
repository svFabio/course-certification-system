...
return new class extends Migration
{
    ...
    {
        DB::statement('ALTER TABLE preinscriptions DROP CONSTRAINT IF EXISTS preinscriptions_status_check');
        DB::statement("ALTER TABLE preinscriptions ADD CONSTRAINT preinscriptions_status_check CHECK (((status)::text = ANY ((ARRAY['pendiente_pago'::character varying, 'inscrito'::character varying, 'retirado'::character varying])::text[])))");
    }
};
